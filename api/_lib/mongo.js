...
if (!uri) {
  throw new Error('Missing MONGODB_URI environment variable'); //throw new error é como se fosse um cosole.log, mas expecifico para Erros e tratamento de erros
}
...
async function getCollection() {
  ...
  const dbName = process.env.MONGODB_DB || 'project_api'; // || -> significa 'ou'
